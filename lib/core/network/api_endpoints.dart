class ApiEndpoints {
  ...
  static const String baseUrl = 'http://10.18.2.161:8000/api/v1';
  ...
  static const String spLetters = '/sp-letters';
  static const String spLettersUnreadCount = '/sp-letters/unread-count';
}